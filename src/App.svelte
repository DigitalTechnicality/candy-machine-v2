    ...
    >
      ...
      <div class="p-6">
        ...
        <div class="text-base sm:text-md font-bold pb-5 text-fuchsia-500 ">
          Send your SolanaDogeNFT to: 'BurnrLYrytDVd29REphrR7x3UDNghWd6ei741jHKQUxy' <br> To receive WL token: <br> 'ASx1nZ68EsiL1Sj2tQshSTEBj9iAH5f1aiMx72rGZqzQ' <br> For FREE minting!
        </div>
        <Button {connection} />
